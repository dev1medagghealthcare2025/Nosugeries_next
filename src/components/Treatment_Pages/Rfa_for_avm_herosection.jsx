  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api.telecrm.in/enterprise/658abddbf911ed2d692b0cf5/autoupdatelead', {
        ...
        body: JSON.stringify({
          fields: {
            ...
            source: 'Website - RFA for AVM Hero Section Form',
          },
        }),
      });
      ...
      if (response.ok) {
        ...
        setFormData({ concern: '', fullName: '', phone: '', city: '', preferredLanguage: '' });
      } else {
        setFormStatus('error');
      }
    } catch (error) {
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='text-white text-center lg:text-left'>
            ...
            <p className='text-base sm:text-lg md:text-xl text-gray-200 font-medium max-w-2xl mx-auto lg:mx-0'>
              Minimally invasive treatment to close off or shrink abnormal blood vessel tangles, reducing the risk of hemorrhage and neurological effects
            </p>
          </div>
...
export default RfaForAvmHeroSection;
