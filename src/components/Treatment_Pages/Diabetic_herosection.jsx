      ...
      const response = await fetch('https://api.telecrm.in/enterprise/658abddbf911ed2d692b0cf5/autoupdatelead', {
        ...
        body: JSON.stringify({
          fields: {
            ...
            source: 'Website - Diabetic Foot Hero Section Form',
          },
        }),
      });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white text-center lg:text-left">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-white mb-3 sm:mb-5">
              Diabetic Foot & Blocked Leg Arteries
            </h1>
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="bg-white rounded-xl shadow-2xl p-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {formStatus === 'success' && (
                  <p className="text-green-600 text-center mt-3 text-sm font-semibold" role="status" aria-live="polite">
                    Thank you for reaching out. Our expert will contact you shortly.
                  </p>
                )}
                {formStatus === 'error' && (
                  <p className="text-red-600 text-center mt-3 text-sm font-semibold" role="status" aria-live="polite">
...
export default DiabeticHeroSection;