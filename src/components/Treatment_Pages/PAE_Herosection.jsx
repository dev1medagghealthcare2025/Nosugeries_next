      ...
      const response = await fetch('https://api.telecrm.in/enterprise/658abddbf911ed2d692b0cf5/autoupdatelead', {
        ...
        body: JSON.stringify({
          fields: {
            ...
            source: 'Website - PAE Hero Section Form',
          },
        }),
      });
            ...
            <div className='bg-white rounded-xl shadow-2xl p-4'>
              ...
              <form onSubmit={handleSubmit}>
                <textarea
                  ...
                  className='w-full border border-gray-200 rounded-lg p-2.5 text-xs sm:text-sm resize-none mb-3 focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all bg-white text-gray-800 placeholder-gray-500'
                  rows='2'
                  required
                ></textarea>
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder='City'
                  className='w-full border border-gray-200 rounded-lg p-2.5 text-xs sm:text-sm mb-3 focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all bg-white text-gray-800 placeholder-gray-500'
                  required
                />
                <select
                ...
                <div className='flex flex-col sm:flex-row gap-2.5 mb-3'>
                  <input
                    ...
                    className='w-full sm:w-1/2 border border-gray-200 rounded-lg p-2.5 text-xs sm:text-sm focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all bg-white text-gray-800 placeholder-gray-500'
                    required
                  />
                  <input
                    type='tel'
