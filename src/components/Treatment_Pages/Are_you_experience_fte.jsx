...
const symptoms = [
  { number: 1, title: 'DIFFICULTY CONCEIVING', desc: 'Infertility due to suspected tubal blockage.' },
  { number: 2, title: 'BLOCKED TUBES ON HSG', desc: 'Proximal occlusion on one or both tubes.' },
  { number: 3, title: 'PREFERENCE TO AVOID IVF', desc: 'Seeking non-surgical, natural conception pathway.' },
  { number: 4, title: 'NO VISIBLE PELVIC INFECTION', desc: 'Healthy uterine and tubal anatomy, confirmed safe for procedure.' },
];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8'>
          {symptoms.map((symptom) => (
            <div key={symptom.number} className='border border-gray-200 md:border-pink-300 rounded-xl p-4 md:p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-300'>
