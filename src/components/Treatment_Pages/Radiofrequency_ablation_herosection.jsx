...
const Radiofrequency_ablation_herosection = () => {
      ...
      const response = await fetch('https://api.telecrm.in/enterprise/658abddbf911ed2d692b0cf5/autoupdatelead', {
        ...
        body: JSON.stringify({
          fields: {
            ...
            source: 'Website - RFA Hero Section Form',
          },
        }),
      });
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='text-white text-center lg:text-left'>
            <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-white mb-3 sm:mb-5'>
              Radiofrequency Ablation (RFA) For Arrhythmia
            </h1>
            <p className='text-base sm:text-lg md:text-xl text-gray-200 font-medium max-w-2xl mx-auto lg:mx-0'>
              A minimally invasive procedure using heat energy to correct irregular heart rhythms—fast, safe relief without open-heart surgery.
            </p>
          </div>
...
export default Radiofrequency_ablation_herosection;
