        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-6 items-start'>
          ...
          <div className='lg:col-span-7 flex flex-col justify-start'>
            ...
            <div className='flex flex-col sm:flex-row gap-3'>
              <Link href='/about' className='inline-block text-center bg-pink-500 hover:bg-pink-600 text-white font-medium text-sm px-6 sm:px-8 py-3 rounded-md transition-colors duration-200 max-w-[150px] w-full sm:w-auto shadow-md'>
                Know More
              </Link>
